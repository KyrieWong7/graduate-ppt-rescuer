%% ============================================================
%%  A Click is All You Need · Beamer 幻灯片模板
%%  Graduate Seminar PPT Rescue Kit — Slide Template
%%  ──────────────────────────────────────────────────────────
%%  引擎 Engine:  XeLaTeX（必须，不支持 pdflatex / must use XeLaTeX）
%%  编译 Compile: xelatex -interaction=nonstopmode slides.tex （两遍/twice）
%%  ──────────────────────────────────────────────────────────
%%  字体/配色请修改 config.tex，勿直接编辑此文件。
%%  To change fonts or colors, edit config.tex only.
%% ============================================================
\documentclass[aspectratio=169,10pt]{beamer}

%% ── 用户配置（字体、配色、页脚）────────────────────────────
%% 修改 config.tex 即可，无需改动模板本体。
%% Edit config.tex to change fonts, colors, footer. Do not edit here.
\input{config.tex}

%% ── 中英文字体（由 config.tex 中的宏控制）───────────────────
...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    \begin{beamercolorbox}[wd=.72\paperwidth,ht=2.3ex,dp=1ex,leftskip=.4cm]{structure}%
      ...
      \footleft%  ← 在 config.tex 中修改 / Edit \footleft in config.tex
    \end{beamercolorbox}%
